...
class CrosswordCreator():
    ...
    def ac3(self, arcs=None):
        ...
        # If no arcs are given, start of all arcs
        if not arcs:
            # Creating arcs: a list of tuples of (x, y) pairs
            arcs = []
    ...
    def assignment_complete(self, assignment):
        ...
        """
        # If there were any None values in the assignment return False, otherwise True
        for var in self.domains:
